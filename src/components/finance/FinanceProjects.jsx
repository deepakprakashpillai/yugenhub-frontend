...
const FinanceProjects = () => {
    ...
    return (
        <div className="h-full flex flex-col md:flex-row gap-6 overflow-hidden">
            {/* Left: Project List */}
            <div className={`w-full md:w-1/3 flex flex-col border-r ${theme.canvas.border} pr-4 h-full`}>
            ...
            <div className={`flex-1 overflow-y-auto h-full pl-2`}>
                {selectedProject ? (
                    <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                <h2 className="text-xl font-bold">{selectedProject.code}</h2>
