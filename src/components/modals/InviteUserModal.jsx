            ...
            >
                ...
                <div className="px-6 py-5 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/50">
                    <div>
                        ...
                        <p className="text-xs text-zinc-500 mt-0.5">Send an invitation to join your workspace</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            {[
                                ...
                                >
                                    ...
                                    <div>
                                        <div className={`text-sm font-bold ${role === r.value ? 'text-white' : 'text-zinc-400'}`}>
                                            {r.label}
                                        </div>
                                        <div className="text-xs text-zinc-500 mt-0.5 leading-relaxed pr-8">
                                            {r.desc}
                                        </div>
                                    </div>
                                    {role === r.value && (
