    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={isEditing ? 'Edit Event' : 'Add New Event'} size="md">
            <form onSubmit={handleSubmit} className="space-y-4">
                {/* Event Type */}
                <div>
                    <label className="block text-sm text-zinc-400 mb-1.5">Event Type *</label>
                    <input
                        type="text"
                        name="type"
                        value={formData.type}
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm text-zinc-400 mb-1.5">Venue Name</label>
                        <input
                            type="text"
                            name="venue_name"
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm text-zinc-400 mb-1.5">Start Date & Time</label>
                        <input
                            type="datetime-local"
                            name="start_date"
                    ...
                    <div>
                        <label className="block text-sm text-zinc-400 mb-1.5">End Date & Time</label>
                        <input
                            type="datetime-local"
                            name="end_date"
